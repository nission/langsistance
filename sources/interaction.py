...
class Interaction:
    ...
    async def think(self, user_id, callback_handler=None) -> bool:
        ...
        self.last_answer, self.last_reasoning = await agent.process(user_id, self.last_query, self.query_id, self.speech, callback_handler)
        self.is_generating = False
