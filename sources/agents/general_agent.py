...
class GeneralAgent(Agent):
    def __init__(self, name, prompt_path, provider, verbose=False, browser=None):
        """
        The general agent is a special agent that divides and conquers the task.
        """
    ...
    async def update_plan(self, goal: str, agents_tasks: List[dict], agents_work_result: dict, id: str,
                          success: bool) -> dict:
        """
    ...
    async def process(self, goal: str, speech_module: Speech) -> Tuple[str, str]:
        ...
        while i < steps and not self.stop:
            ...
            if speech_module: speech_module.speak(
