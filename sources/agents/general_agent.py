                    ...
                    def dynamic_tool_function(user_id: str, query_id: str, params: str):
                        ...
                        try:
                            ...
                            while elapsed < timeout:
                                ...
                                self.logger.info(f"tool response:{response_value}, and type:{type(response_value)}, and elapsed:{elapsed}")

                                if response_value is not None:
                                    # 成功获取到响应值
                                    self.logger.info(f"tool response is not none:{response_value}")
